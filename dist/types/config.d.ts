...
export declare const setAstroI18nextConfig: (
  config: AstroI18nextConfig
) => void;
export declare const astroI18nextConfigBuilder: (
  config: AstroI18nextConfig
) => AstroI18nextConfig;
/**
 ...
 */
export declare const flattenRoutes: (
  routes: AstroI18nextConfig["routes"],
  previous?: string[],
  translatedPrevious?: string[],
  prevResult?: AstroI18nextConfig["flatRoutes"]
