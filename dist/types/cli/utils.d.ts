...
export declare const extractFrontmatterFromAstroSource: (
  source: string
) => string;
export declare const overwriteAstroFrontmatter: (
  source: string,
  frontmatter: string
) => string;
export declare const addDepthToRelativePath: (
  relativePath: string,
  depth?: number
) => string;
/**
...
export declare const resolveRelativePathsLevel: (
  fileContents: string,
  fileDepth: number
) => string;
/**
...
export declare const generateLocalizedFrontmatter: (
 ...
 */
export declare const getAstroPagesPath: (
  pagesDirectoryPath: string,
  childDirToCrawl?: AstroI18nextConfig["defaultLocale"] | undefined,
 ...
 */
export declare const resolveTranslatedAstroPath: (
